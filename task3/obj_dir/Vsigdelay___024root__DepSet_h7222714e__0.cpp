...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT__count1 = vlSelf->sigdelay__DOT__count1;
}
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->rst) {
        vlSelf->__Vdly__sigdelay__DOT__count1 = 0U;
        vlSelf->sigdelay__DOT__count2 = 0U;
    } else if (vlSelf->en) {
